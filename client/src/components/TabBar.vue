<template>
  <v-app-bar flat color="transition" border class="px-md-10 px-0">
    ...
    <template #extension v-if="getters.logged">
      <div class="px-3 w-100 d-flex justify-space-between align-center">
        ...
        <v-tabs>
          <v-tab rounded="sm" color="primary" height="35" to="/create" slider-color="secondary" class="text-body-2" variant="flat">Create</v-tab>
        </v-tabs>
      </div>
    </template>
  </v-app-bar>
